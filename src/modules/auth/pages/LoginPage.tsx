...
export const LoginPage = () => {
  ...
  const imageContent = (
    <div className="text-white space-y-6 max-w-md">
      <h2 className="text-4xl font-bold text-white">Bem-vindo ao SaaS Base</h2>
      ...
      <ul className="space-y-4">
        <li className="flex items-center gap-3">
          ...
          <span className="text-white">Gestão completa do seu negócio</span>
        </li>
        <li className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-primary/30 flex items-center justify-center text-white font-bold">✓</div>
          <span className="text-white">Painel de controle intuitivo</span>
        </li>
        <li className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-primary/30 flex items-center justify-center text-white font-bold">✓</div>
